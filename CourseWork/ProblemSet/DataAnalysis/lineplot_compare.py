...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    gg = ggplot(df, aes('yearID', 'HR' , color= 'teamID')) + geom_point() + geom_line() + ggtitle('Variation is total Number of runs by SFN and LAN teams') + xlab('Runs by teams') + ylab('Teams SFN and LAN')
    return gg
