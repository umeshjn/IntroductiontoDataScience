...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    gg = ggplot(df, aes('yearID', 'HR' , color= 'teamID')) + geom_point() + geom_line() + ggtitle('Variation in total Number of home runs by SFN and LAN teams by year') + xlab('Home Runs by teams') + ylab('Teams SFN and LAN')
    return gg
